    ...
    <div className="livitpage">
      ...
      <div className="indprojectpage1">
        <div className="indprojecthead">
          ...
          <div className="indheadcontent">Vision</div>
        </div>
        <div className="indprojectsubhead">
          Developed a Pinterest clone that enables users to post images, making
          them visible to all other users. This application replicates the core
          functionality of Pinterest, providing a platform for image sharing and
          discovery.
        </div>
      </div>
      <a
        href="https://github.com/Abhishekkjainn/Pinterest-Clone"
        className="indprojectpage2"
      >
        <img src="/visionmockup.png" alt="" className="indfirstimg" />
      </a>
      <div className="indskillsusedpage">
        ...
        <div className="indskillstagdiv">
          ...
          <div className="indskilltag">Social Media</div>
      ...
      <div className="indlogopage">
        ...
        <div className="logodiv">
          <div className="logoimg1">
            <img
              src="/visionimages/visionlogo.png"
              alt=""
          ...
          <div className="logoimg2">
            <img
              src="/visionimages/visionmockupind.png"
              alt=""
              className="logodivimg"
            />
          </div>
